...
var host = "34.127.126.120";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "PitcherOnly2020$";  //password (change to match your db, yes this is very poor practice)
